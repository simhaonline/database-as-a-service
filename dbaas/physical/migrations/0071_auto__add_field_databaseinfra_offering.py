...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatabaseInfra.offering'
        db.add_column(u'physical_databaseinfra', 'offering',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'databaseinfras', null=True, on_delete=models.PROTECT, to=orm['physical.Offering']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatabaseInfra.offering'
        db.delete_column(u'physical_databaseinfra', 'offering_id')
    ...
    models = {
        u'physical.databaseinfra': {
            ...
            'offering': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'databaseinfras'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': u"orm['physical.Offering']"}),
